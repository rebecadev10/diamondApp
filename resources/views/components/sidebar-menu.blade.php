<div class="flex  w-32 px-2 h-full bg-azul text-azul-plomo fill-azul-plomo text-sm items-start justify-center py-2">
    <ul class=" flex flex-col  w-full ">
        <li class="inline-flex w-full py-2 items-center justify-between">
            ...
            <a href=""> Facebook</a>
            <div><svg xmlns="http://www.w3.org/2000/svg" height="16" width="16" viewBox="0 0 512 512">
                    <path
